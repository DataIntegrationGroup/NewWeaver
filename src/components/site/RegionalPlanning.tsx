...
import { Hydrograph } from "@/components/app/Hydrograph"
import {
  wellPoints,
  filterWells,
  wellsWithSeries,
...
/** Hydrograph for one well — delegates to the shared inspector/planning chart. */
function WellHydrograph({ well, dark }: { well: WellSeriesRow; dark: boolean }) {
  return <Hydrograph wellId={well.id} name={well.name} dark={dark} />
}
